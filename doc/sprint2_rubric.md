...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 1 -- https://mcsapps.utm.utoronto.ca/jira/browse/STAC-129, https://mcsapps.utm.utoronto.ca/jira/browse/STAC-134 PR not done by person who was assigned 
...
## Sprint Demo (Max 14 marks) 
  ...
  Your Mark: 13 / 14 -- Frontend documentation is still not sufficent, the documentation should infromation on your frontend code, for example, functions/component descritpions like it was done for backend documentation.

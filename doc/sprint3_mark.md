...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1 
    Value part of the user story is not explicit for STAC-89 (value is provided in the descirption), STAC-102
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0
    Missing CoS for STAC-89, STAC-97, STAC-102, STAC-145
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 2
    Commit messages are supposed to begin with ticket id, not ticket number -- but this seems like a misunderstanding from the rubric

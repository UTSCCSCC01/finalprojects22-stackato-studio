...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    Note: Some user stories don't have the value portion, you have to include it, even if it might seem obvious
...
Your Mark: 1
Note: Make sure commit msgs have the ticket number at the front 
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 3 - architecture diagrams are supposed to be higher level to show the different techonologies you're using and how they communicate with one another
...
## Sprint Demo (Max 14 marks) 
  ...
  - 0 marks = documentation has not been created
    ...
    Your Mark: 1 / 2 - your frontend documentation could be improved, for example you could breifly explain how to some important components/utils and how they could be used.
